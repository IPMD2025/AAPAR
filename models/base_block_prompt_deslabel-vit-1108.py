...
class TransformerClassifier(nn.Module):
    ...
    def forward(self, imgs,ViT_model,des=None,gt_label=None):#,group_arr
       ...
       ###########################
        ...
        # vis_embed = features#feat_cam#torch.cat(([:,:1+self.lmbd],),dim=1)#img_ft[:,1+self.lmbd:]#global_cam[:,0].unsqueeze(1)#+ self.pos_embed #+ self.vis_embed #features_cls_temp #features[:,5:]
