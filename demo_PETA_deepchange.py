...
def main(cfg, args):
    ...
    with torch.no_grad():
        for file_name in os.listdir(args.test_img):
            if file_name !='Pad_datasets':#file_name != 'info' and 
                ...
                for img_path in img_paths:
                    ...
                    image_save_path=save_path+"/"+file_name+"/"+imagename+".jpg"
                    ...
                    for i, val in enumerate(valid_probs):
                        if val:
                            with open(args.test_img + '/' + 'PAR_PETA_0220_0.5.txt', 'a',
                                        encoding='utf-8') as f:
...
def argument_parser():
    ...
    parser.add_argument(
        ...
        default="/media/data2/lx/cloth-changing/dataset/DeepChangeDataset",
    )
    parser.add_argument(
